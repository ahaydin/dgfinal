...
app.post('/api/odeme-baslat', (req, res) => {
    try {
        ...
        // ARTIK HASH (ŞİFRELEME) FORMÜLÜNE GEREK YOK!
        // Banka doğrudan "MerchantPassword" parametresini bekliyor.
        ...
        res.json({
            ...
            formData: {
                ...
                MerchantPassword: STORE_KEY, // İŞTE BÜTÜN SORUNU ÇÖZECEK SATIR BURASI!
                ...
                // Rnd ve Hash satırlarını tamamen kaldırdık
            }
        });
