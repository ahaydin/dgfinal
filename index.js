...
const basariliUrl = "https://dgfinal.onrender.com/basarili";
const basarisizUrl = "https://dgfinal.onrender.com/hata";
...
app.post('/api/odeme-sonuc/basarili', (req, res) => {
    ...
    res.redirect("https://dgfinal.onrender.com/siparis-basarili");
});
...
app.post('/api/odeme-sonuc/basarisiz', (req, res) => {
    ...
    res.redirect("https://dgfinal.onrender.com/siparis-basarisiz");
});
